...
| `AC_REQ_NON_FC_01` | Preserve Account invariants during lifecycle operations            | 🟡 Partial         | Implemented Account lifecycle operations preserve their defined invariants, including AC_UC_05 last-administrator protection; the remaining lifecycle operations are not implemented yet.                           |
...
| `AC_REQ_NON_FC_04` | Exclude soft-deleted accounts from normal Account operations       | 🟡 Partial         | View Accounts and View Account exclude soft-deleted accounts from normal lookup, and AC_UC_05 rejects soft-deleted targets, but the broader Account operations that must enforce this rule are not implemented yet. |
...
| `AC_SEC_REQ_NON_FC_08`   | Do not expose credentials through responses, logs, or administrative views     | 🟡 Partial         | Account API responses exclude credential secrets, including View Account and Deactivate Account, but the broader authentication and account-management surfaces are not complete.       |
...
| `AC_API_06` | `POST`   | `/admin/accounts/{id}/activate`   | `AC_UC_06` Activate Account    | 🔴 Not Implemented | —                                                                                                                                                                                                                             |
| `AC_API_07` | `DELETE` | `/admin/accounts/{id}`            | `AC_UC_07` Soft Delete Account | 🔴 Not Implemented | —                                                                                                                                                                                                                             |
