...
| ID                                    | Status             | Reason                                        |
| ------------------------------------- | ------------------ | --------------------------------------------- |
| `AZ_REQ_FC_01`–`AZ_REQ_FC_25`         | 🔴 Not Implemented | Authorization domain is not implemented.      |
| `AZ_REQ_NON_FC_01`–`AZ_REQ_NON_FC_06` | 🔴 Not Implemented | Authorization enforcement is not implemented. |

## 10.2 Security

| ID                              | Status             | Reason                                             |
| ------------------------------- | ------------------ | -------------------------------------------------- |
| `AZ_SEC_REQ_01`–`AZ_SEC_REQ_09` | 🔴 Not Implemented | Authorization enforcement is not implemented.      |
| `AZ_SEC_DEC_RBAC_01`–`08`       | 🔴 Not Implemented | RBAC model is designed but not implemented.        |
| `AZ_SEC_DEC_AUTHZ_01`–`06`      | 🔴 Not Implemented | Authorization decision service is not implemented. |
| `AZ_SEC_DEC_FAILURE_01`–`04`    | 🔴 Not Implemented | Authorization failure handling is not implemented. |

## 10.3 Data Model

| ID         | Description                     | Status             |
| ---------- | ------------------------------- | ------------------ |
| `AZ_DM_01` | `authorization_role`            | 🔴 Not Implemented |
| `AZ_DM_02` | `authorization_permission`      | 🔴 Not Implemented |
| `AZ_DM_03` | `authorization_role_permission` | 🔴 Not Implemented |
| `AZ_DM_04` | `authorization_account_role`    | 🔴 Not Implemented |

## 10.4 Use Cases

| ID         | Description      | Status             |
| ---------- | ---------------- | ------------------ |
| `AZ_UC_01` | Authorize Action | 🔴 Not Implemented |
...
| Permission                  | Status             |
| --------------------------- | ------------------ |
| `account:view`              | 🔴 Not Implemented |
| `account:view_deleted`      | 🔴 Not Implemented |
| `account:create`            | 🔴 Not Implemented |
| `account:update`            | 🔴 Not Implemented |
| `account:deactivate`        | 🔴 Not Implemented |
| `account:activate`          | 🔴 Not Implemented |
| `account:delete`            | 🔴 Not Implemented |
| `account:restore`           | 🔴 Not Implemented |
| `account:purge`             | 🔴 Not Implemented |
| `account:change_email`      | 🔴 Not Implemented |
| `account:change_password`   | 🔴 Not Implemented |
| `authorization:role_assign` | 🔴 Not Implemented |
| `authorization:role_revoke` | 🔴 Not Implemented |

## 10.6 Integration

| ID          | Description                                       | Status             |
| ----------- | ------------------------------------------------- | ------------------ |
| `AZ_INT_01` | Authentication → Authorization principal contract | 🔴 Not Implemented |
| `AZ_INT_02` | Account → Authorization account reference         | 🔴 Not Implemented |
| `AZ_INT_03` | Authorization middleware/check boundary           | 🔴 Not Implemented |
