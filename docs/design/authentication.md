...
| ID                 | Status             | Reason                                                                                                                                                                                                                                             |
| ------------------ | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AU_REQ_FC_01`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_02`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_03`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_04`     | 🟡 Partial         | Bearer-token validation rejects inactive accounts, including accounts deactivated by AC_UC_05 and restored by AC_UC_08, but the email/password authentication flow is not implemented yet.                                                         |
| `AU_REQ_FC_05`     | 🟡 Partial         | Bearer-token validation rejects soft-deleted accounts, including accounts transitioned to the soft-deleted state by AC_UC_07, while AC_UC_08 restores those accounts to `inactive`; the email/password authentication flow is not implemented yet. |
| `AU_REQ_FC_06`     | 🟢 Implemented     |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_07`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_08`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_09`     | 🟢 Implemented     |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_10`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_11`     | 🟢 Implemented     |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_12`     | 🟢 Implemented     |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_13`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_14`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_15`     | 🟢 Implemented     |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_16`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_17`     | 🟢 Implemented     |                                                                                                                                                                                                                                                    |
| `AU_REQ_FC_18`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
...
| `AU_REQ_NON_FC_03` | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_NON_FC_04` | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
| `AU_REQ_NON_FC_05` | 🔴 Not Implemented |                                                                                                                                                                                                                                                    |
...
| `AU_SEC_DEC_CREDENTIAL_04` | 🟡 Partial         | Bearer-token validation requires `status = active` and `deleted_at IS NULL`; a restored AC_UC_08 account returns as `inactive`, so it remains ineligible for authentication until separately activated, while login-time credential authentication is not implemented yet. |
...
| `AU_SEC_DEC_ACCESS_05`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
...
| `AU_SEC_DEC_ACCESS_10`     | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
...
| `AU_SEC_DEC_REFRESH_01`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_02`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_03`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_04`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_05`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_06`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_07`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_08`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
...
| `AU_SEC_DEC_FAILURE_05`    | 🔴 Not Implemented |                                                                                                                                                                                                                                                                            |
