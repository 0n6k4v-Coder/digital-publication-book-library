...
| ID                 | Status             | Reason                                                                                                                                                                                                 |
| ------------------ | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `AU_REQ_FC_01`     | 🔴 Not Implemented | Account email/password authentication and login are not implemented yet.                                                                                                                               |
| `AU_REQ_FC_02`     | 🔴 Not Implemented | Email/password authentication using the Account domain's email identity is not implemented yet.                                                                                                        |
| `AU_REQ_FC_03`     | 🔴 Not Implemented | Password verification during authentication is not implemented yet.                                                                                                                                    |
| `AU_REQ_FC_04`     | 🟡 Partial         | The Bearer-token validation flow rejects inactive accounts, but the email/password authentication flow is not implemented yet.                                                                         |
| `AU_REQ_FC_05`     | 🟡 Partial         | The Bearer-token validation flow rejects soft-deleted accounts, but the email/password authentication flow is not implemented yet.                                                                     |
| `AU_REQ_FC_06`     | 🟢 Implemented     | `AuthenticatedPrincipal` is implemented and created after successful Bearer-token validation.                                                                                                          |
| `AU_REQ_FC_07`     | 🔴 Not Implemented | Authentication-session creation during login is not implemented yet.                                                                                                                                   |
| `AU_REQ_FC_08`     | 🔴 Not Implemented | Access-token issuance is not implemented yet.                                                                                                                                                          |
| `AU_REQ_FC_09`     | 🟡 Partial         | Bearer access-token validation is implemented, including token, session, and account-state checks, but the flow is not yet wired into every protected Admin API handler.                               |
| `AU_REQ_FC_10`     | 🔴 Not Implemented | No authentication-session revocation operation is implemented yet.                                                                                                                                     |
| `AU_REQ_FC_11`     | 🟢 Implemented     | `authentication_session.id` is a UUID primary key generated by PostgreSQL.                                                                                                                             |
| `AU_REQ_FC_12`     | 🟢 Implemented     | `authentication_access_token.expires_at` is stored and validated during Bearer-token authentication.                                                                                                   |
| `AU_REQ_FC_13`     | 🔴 Not Implemented | Refresh tokens are not implemented.                                                                                                                                                                    |
| `AU_REQ_FC_14`     | 🔴 Not Implemented | Refresh-token rotation is not implemented.                                                                                                                                                             |
| `AU_REQ_FC_15`     | 🟢 Implemented     | Expired access tokens are rejected during Bearer-token validation.                                                                                                                                     |
| `AU_REQ_FC_16`     | 🔴 Not Implemented | Refresh tokens are not implemented.                                                                                                                                                                    |
| `AU_REQ_FC_17`     | 🟢 Implemented     | Revoked authentication sessions cause bound access tokens to be rejected.                                                                                                                              |
| `AU_REQ_FC_18`     | 🔴 Not Implemented | Refresh tokens and refresh-token replay protection are not implemented.                                                                                                                                |
| `AU_REQ_FC_19`     | 🟢 Implemented     | Authentication obtains authentication-relevant account state from the Account database records during token validation.                                                                                |
| `AU_REQ_FC_20`     | 🟢 Implemented     | Authentication does not own canonical Account profile data.                                                                                                                                            |
| `AU_REQ_FC_21`     | 🟢 Implemented     | Authentication does not own the `account_credentials.password_hash`; password storage remains in the Account domain.                                                                                   |
| `AU_REQ_FC_22`     | 🟢 Implemented     | `AuthenticatedPrincipal` provides the authenticated `account_id`.                                                                                                                                      |
| `AU_REQ_FC_23`     | 🟢 Implemented     | `AuthenticatedPrincipal` contains `account_id`, `session_id`, and `authenticated_at`.                                                                                                                  |
| `AU_REQ_FC_24`     | 🟢 Implemented     | Authentication does not evaluate roles or permissions.                                                                                                                                                 |
| `AU_REQ_FC_25`     | 🟢 Implemented     | Authorization consumes `AuthenticatedPrincipal` for the `account:create` permission decision.                                                                                                          |
| `AU_REQ_NON_FC_01` | 🟡 Partial         | The implemented authentication path does not persist raw access tokens or log authentication credentials, but an application-wide logging policy and the authentication endpoints are not implemented. |
| `AU_REQ_NON_FC_02` | 🟢 Implemented     | Access-token persistence stores the SHA-256 verifier rather than the raw token.                                                                                                                        |
| `AU_REQ_NON_FC_03` | 🔴 Not Implemented | Refresh tokens are not implemented.                                                                                                                                                                    |
| `AU_REQ_NON_FC_04` | 🔴 Not Implemented | The backend does not itself enforce HTTPS/TLS.                                                                                                                                                         |
| `AU_REQ_NON_FC_05` | 🔴 Not Implemented | Failed email/password authentication rate limiting is not implemented.                                                                                                                                 |
| `AU_REQ_NON_FC_06` | 🟡 Partial         | Bearer authentication failures do not reveal account-existence information, but the email/password authentication failure flow is not implemented yet.                                                 |
| `AU_REQ_NON_FC_07` | 🟡 Partial         | Authentication error responses use `Cache-Control: no-store`, but login and refresh endpoints are not implemented yet.                                                                                 |

## 8.2 Security Decisions

| Decision ID                | Status             | Reason                                                                                                                                                                                         |
| -------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AU_SEC_DEC_CREDENTIAL_01` | 🔴 Not Implemented | Email/password authentication is not implemented yet.                                                                                                                                          |
| `AU_SEC_DEC_CREDENTIAL_02` | 🟡 Partial         | The Account domain implements the canonical and normalized email rules, but the Authentication domain does not yet have an email/password login flow that uses those rules for authentication. |
| `AU_SEC_DEC_CREDENTIAL_03` | 🔴 Not Implemented | Password verification during authentication is not implemented yet.                                                                                                                            |
| `AU_SEC_DEC_CREDENTIAL_04` | 🟡 Partial         | Bearer-token validation requires `status = active` and `deleted_at IS NULL`, but login-time credential authentication is not implemented yet.                                                  |
| `AU_SEC_DEC_CREDENTIAL_05` | 🔴 Not Implemented | Generic email/password authentication failure handling is not implemented yet.                                                                                                                 |
| `AU_SEC_DEC_CREDENTIAL_06` | 🔴 Not Implemented | Failed authentication rate limiting is not implemented yet.                                                                                                                                    |
| `AU_SEC_DEC_ACCESS_01`     | 🟡 Partial         | Bearer authentication is implemented for the new authentication flow and Create Account, but not yet wired into every protected Admin API handler.                                             |
| `AU_SEC_DEC_ACCESS_02`     | 🟡 Partial         | The authentication extractor reads bearer credentials only from the `Authorization` header, but the new flow is not yet applied to every protected Admin API handler.                          |
| `AU_SEC_DEC_ACCESS_03`     | 🟢 Implemented     | The Bearer parser accepts `Authorization: Bearer <token>` and rejects unsupported or malformed schemes.                                                                                        |
| `AU_SEC_DEC_ACCESS_04`     | 🟡 Partial         | The validation path treats the credential as an opaque token string, but access-token issuance is not implemented yet.                                                                         |
| `AU_SEC_DEC_ACCESS_05`     | 🔴 Not Implemented | Cryptographically secure access-token generation is not implemented yet.                                                                                                                       |
| `AU_SEC_DEC_ACCESS_06`     | 🟢 Implemented     | The database persists only the SHA-256 verifier in `authentication_access_token.token_hash`.                                                                                                   |
| `AU_SEC_DEC_ACCESS_07`     | 🟡 Partial         | Access-token expiration is persisted and validated, but token issuance with the defined 3600-second lifetime is not implemented yet.                                                           |
| `AU_SEC_DEC_ACCESS_08`     | 🟡 Partial         | The validation flow invalidates tokens when their session is revoked, but an explicit session-revocation operation is not implemented yet.                                                     |
| `AU_SEC_DEC_ACCESS_09`     | 🟢 Implemented     | Authorization is handled separately; the access token resolves to an `AuthenticatedPrincipal` and does not grant roles or permissions.                                                         |
| `AU_SEC_DEC_ACCESS_10`     | 🔴 Not Implemented | Access-token generation from at least 256 bits of secure randomness is not implemented yet.                                                                                                    |
| `AU_SEC_DEC_ACCESS_11`     | 🟢 Implemented     | The server computes SHA-256 over the supplied token and uses the resulting verifier for lookup.                                                                                                |
| `AU_SEC_DEC_ACCESS_12`     | 🟢 Implemented     | Each access-token record has exactly one `session_id` foreign key.                                                                                                                             |
| `AU_SEC_DEC_ACCESS_13`     | 🟢 Implemented     | Validation checks token existence, token expiry, session revocation, session expiry, account status, and account deletion state together.                                                      |
| `AU_SEC_DEC_ACCESS_14`     | 🟢 Implemented     | Lookup is performed exclusively using the server-computed SHA-256 verifier.                                                                                                                    |
| `AU_SEC_DEC_ACCESS_15`     | 🟢 Implemented     | A valid access token remains usable until token, session, or account authentication state becomes invalid.                                                                                     |
| `AU_SEC_DEC_ACCESS_16`     | 🟡 Partial         | The raw token is not persisted or logged by the implemented validation path, but token issuance and the corresponding issuance-only response behavior are not implemented yet.                 |
| `AU_SEC_DEC_REFRESH_01`    | 🔴 Not Implemented | Refresh-token functionality is not implemented.                                                                                                                                                |
| `AU_SEC_DEC_REFRESH_02`    | 🔴 Not Implemented | Refresh tokens are not implemented.                                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_03`    | 🔴 Not Implemented | Refresh-token verifier storage is not implemented.                                                                                                                                             |
| `AU_SEC_DEC_REFRESH_04`    | 🔴 Not Implemented | Refresh-token rotation is not implemented.                                                                                                                                                     |
| `AU_SEC_DEC_REFRESH_05`    | 🔴 Not Implemented | Refresh-token replay protection is not implemented.                                                                                                                                            |
| `AU_SEC_DEC_REFRESH_06`    | 🔴 Not Implemented | Refresh tokens and their session binding are not implemented.                                                                                                                                  |
| `AU_SEC_DEC_REFRESH_07`    | 🔴 Not Implemented | Refresh-token revocation is not implemented.                                                                                                                                                   |
| `AU_SEC_DEC_REFRESH_08`    | 🔴 Not Implemented | Refresh-token expiration is not implemented.                                                                                                                                                   |
| `AU_SEC_DEC_FAILURE_01`    | 🟢 Implemented     | Missing Bearer credentials produce `401` with `WWW-Authenticate: Bearer realm="admin-api"` in the implemented authentication flow.                                                             |
| `AU_SEC_DEC_FAILURE_02`    | 🟢 Implemented     | Invalid Bearer credentials produce `401` with `WWW-Authenticate: Bearer realm="admin-api", error="invalid_token"` in the implemented authentication flow.                                      |
| `AU_SEC_DEC_FAILURE_03`    | 🟢 Implemented     | Expired access tokens are treated as invalid Bearer authentication.                                                                                                                            |
| `AU_SEC_DEC_FAILURE_04`    | 🟢 Implemented     | Revoked sessions cause Bearer authentication to fail as invalid authentication.                                                                                                                |
| `AU_SEC_DEC_FAILURE_05`    | 🔴 Not Implemented | Generic email/password login failure handling is not implemented yet.                                                                                                                          |
| `AU_SEC_DEC_FAILURE_06`    | 🟢 Implemented     | The Bearer-token validation query requires an active account.                                                                                                                                  |
| `AU_SEC_DEC_FAILURE_07`    | 🟢 Implemented     | The Bearer-token validation query requires `deleted_at IS NULL`.                                                                                                                               |
| `AU_SEC_DEC_PRINCIPAL_01`  | 🟢 Implemented     | `AuthenticatedPrincipal` contains `account_id`.                                                                                                                                                |
| `AU_SEC_DEC_PRINCIPAL_02`  | 🟢 Implemented     | `AuthenticatedPrincipal` contains `session_id`.                                                                                                                                                |
| `AU_SEC_DEC_PRINCIPAL_03`  | 🟢 Implemented     | `AuthenticatedPrincipal` contains `authenticated_at`.                                                                                                                                          |
| `AU_SEC_DEC_PRINCIPAL_04`  | 🟢 Implemented     | Roles are not part of `AuthenticatedPrincipal`.                                                                                                                                                |
| `AU_SEC_DEC_PRINCIPAL_05`  | 🟢 Implemented     | Permissions are not part of `AuthenticatedPrincipal`.                                                                                                                                          |
| `AU_SEC_DEC_SESSION_01`    | 🟢 Implemented     | `authentication_session` exists as the server-side session record binding accounts and access tokens.                                                                                          |
| `AU_SEC_DEC_SESSION_02`    | 🟢 Implemented     | `authentication_session.id` is a UUID primary key.                                                                                                                                             |
| `AU_SEC_DEC_SESSION_03`    | 🟢 Implemented     | Session expiration is stored in `expires_at` and checked during token validation.                                                                                                              |
| `AU_SEC_DEC_SESSION_04`    | 🟢 Implemented     | `revoked_at IS NULL` is required for successful Bearer authentication.                                                                                                                         |
...
| `AU_SEC_DEC_SESSION_06`    | 🟢 Implemented     | `authentication_session.account_id` references `account.id`.                                                                                                                                   |

## 8.3 Design Decisions

| ID                              | Status             | Reason |
| ------------------------------- | ------------------ | ------ |
| Authentication responsibilities | 🟡 Partial         | Bearer-token validation and `AuthenticatedPrincipal` creation are implemented, but credential verification, session creation, token issuance, refresh, and revocation are not implemented. |
| Authentication flow             | 🔴 Not Implemented | The login flow that verifies email/password credentials, creates a session, and issues tokens is not implemented. |
| Protected request flow          | 🟡 Partial         | The protected-request authentication sequence is implemented in the authentication extractor and repository, but Create Account is the only current Account endpoint wired to the new authentication/authorization flow. |
| Refresh flow                    | 🔴 Not Implemented | Refresh-token issuance, rotation, replay protection, and validation are not implemented. |

## 8.4 Data Model

| ID         | Data Model                     | Status             | Reason |
| ---------- | ------------------------------ | ------------------ | ------ |
| `AU_DM_01` | `authentication_session`       | 🟢 Implemented     | The `authentication_session` table is implemented with account binding, expiration, authentication timestamp, and revocation fields. |
| `AU_DM_02` | `authentication_refresh_token` | 🔴 Not Implemented | No `authentication_refresh_token` table or equivalent refresh-token persistence exists in the current backend. |
| `AU_DM_03` | `authentication_access_token`  | 🟢 Implemented     | The `authentication_access_token` table is implemented with session binding, unique SHA-256 verifier storage, creation time, expiration time, and session cascade deletion. |

## 8.5 Use Cases

| ID         | Description                    | Status             | Reason                                                                                                                                                                                                                                   |
| ---------- | ------------------------------ | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AU_UC_01` | Authenticate Account           | 🔴 Not Implemented | The email/password login flow, session creation, and token issuance are not implemented.                                                                                                                                                 |
| `AU_UC_02` | Refresh Authentication         | 🔴 Not Implemented | Refresh tokens, rotation, replay protection, and refresh-token persistence are not implemented.                                                                                                                                          |
| `AU_UC_03` | Revoke Authentication          | 🔴 Not Implemented | No authentication-session revocation operation is implemented.                                                                                                                                                                           |
| `AU_UC_04` | Validate Bearer Authentication | 🟡 Partial         | Bearer parsing, SHA-256 verifier lookup, token expiry checks, session validation, account-state validation, and `AuthenticatedPrincipal` creation are implemented, but the flow is not yet wired into every protected Admin API handler. |

## 8.6 API Contract

| ID               | Description              | Status             | Reason                                                                                                                                                                                  |
| ---------------- | ------------------------ | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AU_API_01`      | `POST /auth/login`       | 🔴 Not Implemented | No `/auth/login` endpoint or email/password authentication flow is implemented.                                                                                                         |
| `AU_API_02`      | `POST /auth/refresh`     | 🔴 Not Implemented | No refresh-token endpoint or refresh-token implementation exists.                                                                                                                       |
| `AU_API_03`      | `POST /auth/logout`      | 🔴 Not Implemented | No authentication-session revocation endpoint is implemented.                                                                                                                           |
| `AU_CONTRACT_01` | `AuthenticatedPrincipal` | 🟢 Implemented     | `AuthenticatedPrincipal` is implemented with `account_id`, `session_id`, and `authenticated_at`, and is consumed by the authorization layer for the Create Account permission decision. |
